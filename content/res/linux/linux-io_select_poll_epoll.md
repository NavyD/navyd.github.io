...
![blocking IO](./resources/images/1593755892-55c466c2b5fc5.png)
...
![nonblocking IO](resources/images/1505222224-55c466dda9803_articlex.png)
...
![IO multiplexing](resources/images/1903235121-55c466eb17665_articlex.png)
...
![asynchronous IO](resources/images/1311869885-55c466fac00ba_articlex.png)
...
![IO Model](resources/images/2109320510-55c4670795194_articlex.png)
...
如果我们在第1步将RFD添加到epoll描述符的时候使用了EPOLLET标志，那么在***第5步调用epoll_wait(2)之后将有可能会挂起***，因为剩余的数据还存在于文件的输入缓冲区内，而且数据发出端还在等待一个针对已经发出数据的反馈信息。只有在监视的文件句柄上发生了某个事件的时候 ET 工作模式才会汇报事件。因此在***第5步的时候，调用者可能会放弃等待仍在存在于文件输入缓冲区内的剩余数据***。
...
[Linux IO模式及 select、poll、epoll详解](https://segmentfault.com/a/1190000003063859#item-3-12)
